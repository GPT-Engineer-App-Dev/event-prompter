...
- In the login page there you be a way of registering with email, username and password
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/event-prompter.git
cd event-prompter
npm i
```
